...
const colors = [
  ...
  { name: 'Blue', class: 'bg-blue-700', selectedClass: 'ring-blue-400' },
  { name: 'Yellow', class: 'bg-yellow-400', selectedClass: 'ring-yellow-400' },
  { name: 'Purple', class: 'bg-purple-500', selectedClass: 'ring-purple-400' },
  { name: 'White', class: 'bg-white', selectedClass: 'ring-orange-400' },
  { name: 'Pink', class: 'bg-pink-400', selectedClass: 'ring-pink-400' },
  { name: 'Black', class: 'bg-gray-900', selectedClass: 'ring-teal-400' },
];
