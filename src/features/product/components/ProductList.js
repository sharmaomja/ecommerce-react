...
export default function ProductList() {
  ...
  const handleShowMoreFilterOptions = () => {
    setVisibleFilterOptions(
      visibleFilterOptions === MAX_VISIBLE_FILTER_OPTIONS ? filters.length : MAX_VISIBLE_FILTER_OPTIONS
    );
  };
      ...
      <div>
        ...
        <div className="bg-white">
          <div>
            ...
            <div className="lg:w-7/9 ml-0 lg:ml-3">
                ...
                <section aria-labelledby="products-heading" className="pb-24 pt-6">
                  ...
                  <div className="grid grid-cols-1 gap-x-4 gap-y-10 lg:grid-cols-6">
                    ...
                    <div className="lg:col-span-5">
                      <div className="mt-2 grid grid-cols-2 gap-x-6 gap-y-10 sm:grid-cols-4 lg:grid-cols-5 xl:gap-x-8">
